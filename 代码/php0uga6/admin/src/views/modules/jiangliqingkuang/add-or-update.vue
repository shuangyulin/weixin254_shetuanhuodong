<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖励积分" prop="jianglijifen">
          <el-input v-model="ruleForm.jianglijifen" 
              placeholder="奖励积分" clearable  :readonly="ro.jianglijifen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖励积分" prop="jianglijifen">
              <el-input v-model="ruleForm.jianglijifen" 
                placeholder="奖励积分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='jianglijifen'){
            this.ruleForm.jianglijifen = obj[o];
	    this.ro.jianglijifen = true;
            continue;
          }
          if(o=='dengjishijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiangliqingkuang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiangliqingkuangCrossAddOrUpdateFlag = false;
						 this.parent.search();
