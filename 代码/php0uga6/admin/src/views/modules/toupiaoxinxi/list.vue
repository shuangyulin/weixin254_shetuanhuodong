  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="投票结果" prop="toupiaojieguo">
		  <el-select  @change="toupiaojieguoChange" clearable v-model="searchForm.toupiaojieguo" placeholder="请选择投票结果">
		    <el-option
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.toupiaojieguo!='' && this.searchForm.toupiaojieguo!=undefined){
