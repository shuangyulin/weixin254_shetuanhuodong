<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="投票编号" prop="toupiaobianhao">
            <el-input v-model="ruleForm.toupiaobianhao" 
                placeholder="投票编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.toupiaobianhao" label="投票编号" prop="toupiaobianhao">
              <el-input v-model="ruleForm.toupiaobianhao" 
                placeholder="投票编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.toupiaoshijian" label="投票时间" prop="toupiaoshijian">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="投票结果" prop="toupiaojieguo">
          <el-select :disabled="ro.toupiaojieguo" v-model="ruleForm.toupiaojieguo" placeholder="请选择投票结果">
            <el-option
                v-for="(item,index) in toupiaojieguoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="投票结果" prop="toupiaojieguo">
	      <el-input v-model="ruleForm.toupiaojieguo"
                placeholder="投票结果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
